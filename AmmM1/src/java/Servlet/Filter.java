        ...
        if(session.getAttribute("loggedIn") != null){
            ...
            if (command != null) 
            {
                ...
                if (command.equals("search")) 
                {
                    ...
                    // Esegue la ricerca
                    ArrayList<Prodotti> listaProdotti = OggettiFactory.getInstance()
                            .getProdottiList(request.getParameter("text"));
                    ...
                    request.getRequestDispatcher("listaProdottiJason.jsp").
